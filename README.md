...
```
Note: It is recommended that when you upload the file to the brightcove repository it is recommended that you include the version number of the RDM Video Cloud Plugin to the filename for example set the file name as
```shell
